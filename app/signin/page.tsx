  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
      <div className="bg-white p-8 shadow-lg rounded-xl w-full max-w-sm">
        <h2 className="text-2xl font-semibold text-blue-600 mb-8 text-center">Sign In</h2>
        <form className="space-y-6">
          ...
          <Button className="w-full py-3 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition-colors">
            Sign In
          </Button>
        </form>
